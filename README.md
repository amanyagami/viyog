...
Expected headline numbers (CIFAR-100, `ViyogD_tv_dorm` — the deployed detector,
`src/viyog`'s own `tv` statistic), regenerated by the command above and matching
`results/analysis/master_comparison_cifar100.csv`:

| Metric | Value |
| --- | --- |
| T2 (ID-vs-ADV) AUROC | **0.966** |
| T3 (OOD-vs-ADV) AUROC | **0.824** |
